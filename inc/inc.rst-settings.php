...
<?php echo apply_filters('rowseats-userregistration-settings-hidden',''); ?><?php echo apply_filters('rowseats-generel_admission-settings-hidden',''); ?><?php echo apply_filters('rowseats-table-settings-hidden',''); ?><?php echo apply_filters('rowseats-amenities-settings-hidden',''); ?>
