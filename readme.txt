...
= 2.68 =
* Possible security vunerability identified, now patched. Thanks to Robert R from pagely.com
* Changed old function for split() 
* curPageURL() class now changed to work with older themes
* Need to update (if purchased) the following modules: General Admission, Offline Reservations, Offline Payment, Members Management, Row Seats Table. For mobile core, Row Seats Mobile.

= 2.66 =
* Bug fix for fees module and PayPal conflict, not taking 3 decimals such as 10.650. Now fixed.
